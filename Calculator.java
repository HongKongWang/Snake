...
public class Calculator {
	...
	public String calculate(String expression) throws NumberFormatException {
		if(expression.startsWith(".")){//若表達式以"."開頭，進行字符串拼接
			return calString(expression.replaceFirst(".", ""));
		}else{
		OP.put('!', 1);OP.put('^', 1);
    ...
    String calString(String str){
    	String result="";
    	String[] s=Snake.jtaWriter.split(str, "[+]");
    ...
    private String findString(String str) throws NumberFormatException{
    	if(str.startsWith("'")&&str.endsWith("'")){
    		...
    		if(Snake.obj.containsKey(str))return Snake.obj.get(str);
